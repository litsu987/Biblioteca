...
class Usuari(models.Model):
    ...
    email = models.EmailField(default="")  # Agregado el campo para el correo electrónico con valor predeterminado
    nom = models.CharField(max_length=50, default="")  # Campo para el nombre con valor predeterminado
    cognoms = models.CharField(max_length=100, default="")  # Campo para los apellidos con valor predeterminado
